...
if "%choice%"=="1" (
    ...
    if "%topic%"=="" (
        python src\generators\post_social.py --generate linkedin
    ) else (
        python src\generators\post_social.py --generate linkedin --topic "%topic%"
    )
    goto menu
)
...
if "%choice%"=="2" (
    ...
    set /p topic="Topic (press Enter for auto): "
    if "%topic%"=="" (
        python src\generators\post_social.py --generate twitter
    ) else (
        python src\generators\post_social.py --generate twitter --topic "%topic%"
    )
    goto menu
)
...
if "%choice%"=="3" (
    ...
    set /p topic="Topic (press Enter for auto): "
    if "%topic%"=="" (
        python src\generators\post_social.py --generate all
    ) else (
        python src\generators\post_social.py --generate all --topic "%topic%"
    )
    goto menu
)
...
if "%choice%"=="4" (
    ...
    python src\generators\post_social.py --platform linkedin --file "demo_vault\Pending_Approval\%file%"
    goto menu
)
...
if "%choice%"=="5" (
    ...
    echo.
    set /p file="File name: "
    python src\generators\post_social.py --platform twitter --file "demo_vault\Pending_Approval\%file%"
    goto menu
)
...
if "%choice%"=="6" (
    ...
    for %%f in (demo_vault\Pending_Approval\SOCIAL_*.md) do (
        echo Posting: %%f
        python src\generators\post_social.py --platform all --file "%%f"
    )
    goto menu
)
...
if "%choice%"=="7" (
    ...
    python src\generators\post_social.py --platform linkedin --text "%text%"
    goto menu
)
...
if "%choice%"=="8" (
    ...
    python src\generators\post_social.py --platform twitter --text "%text%"
    goto menu
)
