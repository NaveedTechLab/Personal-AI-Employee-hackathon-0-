#!/usr/bin/env python3
"""Auto-generated launcher for LinkedIn MCP"""
import sys
import os
from pathlib import Path

# Add the scripts directory to Python path for local imports
scripts_dir = r"E:\hackathon 0 qwen\Personal-AI-Employee\.claude\skills\linkedin-posting-automation\scripts"
...
exec(open(os.path.join(scripts_dir, "linkedin_api_integration.py"), encoding="utf-8").read())
