#!/usr/bin/env python3
"""Auto-generated launcher for Google Calendar MCP"""
import sys
import os
from pathlib import Path

# Add the scripts directory to Python path for local imports
scripts_dir = r"E:\hackathon 0 qwen\Personal-AI-Employee\.claude\skills\calendar-mcp-server\scripts"
...
# Set environment
os.environ.setdefault("MCP_PORT", "8008")
...
exec(open(os.path.join(scripts_dir, "calendar_mcp_server.py"), encoding="utf-8").read())
