#!/usr/bin/env python3
"""Auto-generated launcher for Twitter/X MCP"""
import sys
import os
from pathlib import Path

# Add the scripts directory to Python path for local imports
scripts_dir = r"E:\hackathon 0 qwen\Personal-AI-Employee\.claude\skills\twitter-mcp-server\scripts"
...
# Set environment
os.environ.setdefault("MCP_PORT", "8003")
...
sys.path.insert(0, r"E:\hackathon 0 qwen\Personal-AI-Employee\.claude\skills\twitter-mcp-server")
...
main_path = os.path.join(scripts_dir, "twitter_mcp_server.py")
...
package_name = "twitter_mcp_server"
...
for py_file in Path(scripts_dir).glob("*.py"):
    if py_file.stem != "__init__" and py_file.stem != "twitter_mcp_server":
